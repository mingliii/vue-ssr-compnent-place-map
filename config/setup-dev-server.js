...
const setupDevServer = (app, onServerBundleReady) => {
  ...
  Object.entries(clientConfig.entry).forEach(([key, value]) => {
    clientConfig.entry[key] = ['webpack-hot-middleware/client', value];
  })
  ...
  serverCompiler.watch({}, (error, stats) => {
    ...
    const bundle = JSON.parse(mfs.readFileSync(require('path').join(serverConfig.output.path, 'vue-ssr-server-bundle.json'), 'utf-8'));
