...
const setupDevServer = (app, onServerBundleReady) => {
    ...
    clientConfig.entry.places = ['webpack-hot-middleware/client', clientConfig.entry.places];
    // clientConfig.entry.place = ['webpack-hot-middleware/client', clientConfig.entry.place];
